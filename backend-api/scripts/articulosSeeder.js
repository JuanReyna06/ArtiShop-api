...
export async function inicializarArticulos() {
    const cantidad = await Articulo.count();
    if(cantidad>0){
        console.log("No se pueden insertar articulos, ya existen");
        return;
    };
    console.log(" 🔴 ---- Incializando Articulos ---- ");
    ...
    console.log(" 🟢 ---- Articulos Inicializados ---- ");
}