...
function ListadoArticulos({Items, RegistrosTotal, Consultar, Modificar, Activar, Pagina, Buscar, Paginas, Imprimir}) {
    return (
                   ...
                   {Items && Items.map((item) => (
                       <tr key={item.IdArticulo} className="table__row">
                           ...
                           <td className="table__content">
                               ...
                               <button className="button__form-activar" title={item.Activo ? "Desactivar" : "Activar"} onClick={()=>Activar(item)}>
                                <i></i>
                                </button>
                           </td>
                       </tr>
